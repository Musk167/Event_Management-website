$(document).ready(function(){
    ...
    for(i in y)
    {
    if(y[c].username === username)
    {
    if(y[c].Password === password)
    flag=0;
    else
    flag=1;
    }
    ...
    * ====================== */
    ...
    positionArray = [position3, position2, position5, position4, position1, position6,
    position7, position8];
    };
    /* ====================== *
    * Create Shapes *
    * ====================== */
    ...
    'M 700 350 L 500 350 L 700 500 L 400 400 L 200 450 L 250 350 L 100 300 L 150 50 L 350 100
    L 250 150 L 450 150 L 400 50 L 550 150 L 350 250 L 650 150 L 650 50 L 700 150 L 600 250 L 750
    250 L 650 300 L 700 350 '
    ];
